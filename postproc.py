...
newline = ''
newcode = ''
notused = ['T1','S','M','H0','M06','G4','G10','L','G28','G30','G92','G20','G43','G53','G21','M5','M6','M25','H0','G40','G49','M99'] # G17,G18,G19,G80,G49
		...
		for word in words:
			if (word[0] == 'F' or word[0] == 'f') and len(word) >= 2:
				try:
					...
					pass
			elif (word[0] == 'Z' or word[0] == 'z') and len(word) >= 2 and not('ZMIN=' in word):
				origZ = float(word[1:])
				origZ = origZ - Zoffset
				word = 'Z' + str(origZ)
				#print word
